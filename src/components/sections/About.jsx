    ...
    >
      <RevealOnScroll>
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="rounded-xl p-8 border-white/30 border hover:-translate-y-1 transition-all bg-orange-500/75">
              ...
              <div className="rounded-xl p-6 hover:-translate-y-1 transition-all">
                ...
                <div className="flex flex-wrap gap-2">
                  {frontendSkills.map((tech, key) => (
                    <span
                      key={key}
                      className="bg-orange-600 text-white py-1 px-3 rounded-full text-sm hover:bg-red-500/20 
